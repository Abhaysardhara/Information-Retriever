...
class User{
	...
	function emailExists(){
		...
		$query = "SELECT id, firstname, lastname, access_level, password, status, nick_name, user_type
	...
	function getUser() {
		...
		$query = "SELECT id, firstname, lastname, email, contact_number, 
				address, password, access_level, user_type, nick_name, status
				FROM " . $this->table_name . "
				WHERE id = ?
				LIMIT 0,1";
		// prepare the query
	...
	function editUser() {
		...
		$sql = "UPDATE users SET firstname = '$this->firstname', lastname = '$this->lastname', address = '$this->address', email = '$this->email', contact_number = '$this->contact_number', nick_name = '$this->nick_name', access_level = '$this->access_level', status = '$this->status' WHERE id = '$this->id'";
